    ...
    <>
      ...
      <div className={`sticky-wrapper ${isSticky ? 'is-sticky' : ''}`}>
        ...
        <div className="container">
          ...
          <a href="/" className="navbar-brand mx-auto mx-lg-0">Freelen Work</a>
            <div className="d-flex align-items-center d-lg-none">
                <i className="navbar-icon bi-telephone-plus me-3"></i>
                <a className="custom-btn btn" href="index#section_5">
                    801-970-4808
                </a>
            </div>
              <div className="collapse navbar-collapse" id="navbarNav">
                  <ul className="navbar-nav ms-lg-5">
                      <li className="nav-item">
                          <a className="nav-link click-scroll" href="index#section_1">Home</a>
                      </li>
                      <li className="nav-item">
                          <a className="nav-link click-scroll" href="index#section_2">About</a>
                      </li>
                      <li className="nav-item">
                          <a className="nav-link click-scroll" href="index#section_3">Services</a>
                      </li>
                      <li className="nav-item">
                          <a className="nav-link click-scroll" href="index#section_4">Projects</a>
                      </li>
                      <li className="nav-item">
                          <a className="nav-link click-scroll" href="index#section_5">Contact</a>
                      </li>
                  </ul>
                  ...
                  <div className="row">
                      <div className="col-lg-7 col-12">
                          <div className="hero-text">
                              ...
                              <p className="mb-4"><a className="custom-btn btn custom-link" href="index#section_2">Let's begin</a></p>
                          </div>
                      </div>
